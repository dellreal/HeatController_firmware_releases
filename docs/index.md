...
1. [1. Главный экран приложения](#1-главный-экран-приложения)
...
2. [2. Экран настроек](#2-экран-настроек)
    * [2.1. Обновление](#21-обновление)
    * [2.2. Сеть](#22-сеть)
    * [2.3. Система](#23-система)
    * [2.4. Безопасность](#24-безопасность)
    * [2.5. Статистика устройств](#25-статистика-устройств)
