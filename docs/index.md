...
* **Порядок уровней** — задаёт порядок переключения уровней в пользовательском режиме и связанную с ним индикацию физических кнопок. Обычный порядок: «1 -> 2 -> 3». Инвертированный порядок: «3 -> 2 -> 1» *(подобно автомобилям VAG)*. Количество миганий светодиода всегда соответствует фактически выбранному уровню: 1-й уровень — 1 мигание, 2-й — 2 мигания, 3-й — 3 мигания.
